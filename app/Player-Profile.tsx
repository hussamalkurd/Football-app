          ...
          Player ID: {id}
            ...
            <View style={styles.container}>
                ...
                <View style={styles.contentContainer}>
                    {activeTab === 'Profile' && <Text>Market Value Development</Text>}
                    {activeTab === 'Legacy' && <Text>Legacy Details</Text>}
                    {activeTab === 'Transfers' && <Text>Transfer History</Text>}
                    {activeTab === 'Stats' && <Text>Player Stats</Text>}
                </View>
            </View>
        </ScrollView>
    );
